...
export const LOCAL_ORIGIN = process.env.LOCAL_ORIGIN as string;
export const PRODUCTION_ORIGIN = process.env.PRODUCTION_ORIGIN as string;
export const LOCAL_DB_URL = process.env.LOCAL_DB_URL as string;
export const PRODUCTION_DB_URL = process.env.PRODUCTION_DB_URL as string;
